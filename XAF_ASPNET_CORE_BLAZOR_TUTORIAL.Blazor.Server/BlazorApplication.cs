...
namespace XAF_ASPNET_CORE_BLAZOR_TUTORIAL.Blazor.Server {
    public partial class XAF_ASPNET_CORE_BLAZOR_TUTORIALBlazorApplication : BlazorApplication {
        public XAF_ASPNET_CORE_BLAZOR_TUTORIALBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XAF_ASPNET_CORE_BLAZOR_TUTORIALBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
