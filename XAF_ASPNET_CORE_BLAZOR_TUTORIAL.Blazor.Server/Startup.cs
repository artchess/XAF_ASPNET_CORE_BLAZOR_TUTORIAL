...
using XAF_ASPNET_CORE_BLAZOR_TUTORIAL.Blazor.Server.Services;
...
namespace XAF_ASPNET_CORE_BLAZOR_TUTORIAL.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<XAF_ASPNET_CORE_BLAZOR_TUTORIALBlazorApplication>(Configuration);
            services.AddXafSecurity(options => {
                ...
                options.UserType = typeof(XAF_ASPNET_CORE_BLAZOR_TUTORIAL.Module.BusinessObjects.ApplicationUser);
                // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                // Comment out the following line if using PermissionPolicyUser or a custom user type.
                options.UserLoginInfoType = typeof(XAF_ASPNET_CORE_BLAZOR_TUTORIAL.Module.BusinessObjects.ApplicationUserLoginInfo);
